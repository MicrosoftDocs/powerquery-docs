...
> [!NOTE]
> Sometimes you might notice a notification that tells you a premium capacity is requiered to refresh a dataflow with a custom function. You can ignore this message and reopen the dataflow editor. This usually solves your problem unless your function refers to a "load enabled" query.
