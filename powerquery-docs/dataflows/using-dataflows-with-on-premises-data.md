...
- Dataflow refresh may fail if an out of date data gateway is used. Starting April 2022, the minimum required version data gateway version is Feburary 2021.
