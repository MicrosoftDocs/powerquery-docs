...
You can now get data from dataflow entities in Power BI Desktop using the dataflow or Dataverse connectors (depending on what type of dataflow you're using, analytical or standard).
