...
- Mapping to Choices (Option Sets) columns using labels is not supported. Instead, use a comma seperated list of values (integers) containing the values of the labels. For example: If you have the following labels: "Choice1,Choice2,Choice3" with corresponding values of "1,2,3", then you should use "1,3" to select the first and last choices.
