...
* Incremental refresh configuraiton is not currently supported when deploying solutions. After deployment of the dataflow via solution, the incremental refresh configuration should be re-applied.
