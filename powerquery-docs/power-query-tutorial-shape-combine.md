...
Since we're inserting a step, Power Query Editor warns us about the danger of doing so - subsequent steps could cause the query to break. We need to be careful, and thoughtful! Since this is a tutorial, and we're highlighting a really cool feature of Power Query Editor to demonstrate how you can create, delete, insert, and reorder steps, we'll push ahead and select **Insert**.
...
Okay that was a little involved, but it was a good example of how powerful and versatile Power Query Editor can be.
