...
| --- | --- | --- |
| **Text** | :::image type="icon" source="media/data-types/text_20.png" border="false"::: | A Unicode character data string. Can be strings, numbers, or dates represented in a text format. Maximum string length is 268,435,456 Unicode characters (where each Unicode character is 2 bytes) or 536,870,912 bytes. |
| **True/False** | :::image type="icon" source="media/data-types/logical_20.png" border="false"::: | A Boolean value of either True or False. |
| **Decimal number** | :::image type="icon" source="media/data-types/number_20.png" border="false"::: | Represents a 64-bit (eight-byte) floating-point number. It's the most common number type, and corresponds to numbers as you usually think of them. Although designed to handle numbers with fractional values, it also handles whole numbers. The Decimal Number type can handle negative values from &ndash;1.79E +308 through &ndash;2.23E &ndash;308, 0, and positive values from 2.23E &ndash;308 through 1.79E + 308. For example, numbers like 34, 34.01, and 34.000367063 are valid decimal numbers. The largest precision that can be represented in a Decimal Number type is 15 digits long. The decimal separator can occur anywhere in the number. The Decimal Number type corresponds to how Excel stores its numbers. A binary floating-point number can't represent all numbers within its supported range with 100% accuracy. Thus, minor differences in precision might occur when representing certain decimal numbers. |
| **Fixed decimal number** | :::image type="icon" source="media/data-types/currency_20.png" border="false"::: | Also known as the Currency type, this data type has a fixed location for the decimal separator. The decimal separator always has four digits to its right and allows for 19 digits of significance. The largest value it can represent is 922,337,203,685,477.5807 (positive or negative). Unlike Decimal Number, the Fixed Decimal Number type is always precise and is thus useful in cases where the imprecision of floating-point notation might introduce errors. |
| **Whole number** | :::image type="icon" source="media/data-types/whole-number_20.png" border="false"::: | Represents a 64-bit (eight-byte) integer value. Because it's an integer, it has no digits to the right of the decimal place. It allows for 19 digits; positive or negative whole numbers between &ndash;9,223,372,036,854,775,807 (&ndash;2^63+1) and 9,223,372,036,854,775,806 (2^63&ndash;2). It can represent the largest possible precision of the various numeric data types. As with the Fixed Decimal Number type, the Whole Number type can be useful in cases where you need to control rounding. |
| **Percentage** | :::image type="icon" source="media/data-types/percentage_20.png" border="false"::: | Fundamentally the same as a Decimal Number type, but it has a mask to format the values in the column as a percentage in the Power Query Editor window. |
| **Date/Time** | :::image type="icon" source="media/data-types/datetime_20.png" border="false"::: | Represents both a date and time value. Underneath the covers, the Date/Time value is stored as a Decimal Number type, so you can actually convert between the two. The time portion of a date is stored as a fraction to whole multiples of 1/300 seconds (3.33 ms). Dates between the years 1900 and 9999 are supported. |
| **Date** | :::image type="icon" source="media/data-types/date_20.png" border="false"::: | Represents just a date (no time portion). When converted into the model, a Date is the same as a Date/Time value with zero for the fractional value. |
| **Time** | :::image type="icon" source="media/data-types/time_20.png" border="false"::: | Represents just time (no date portion). When converted into the model, a Time value is the same as a Date/Time value with no digits to the left of the decimal place. |
| **Date/Time/Timezone** | :::image type="icon" source="media/data-types/datetimezone_20.png" border="false"::: | Represents a UTC Date/Time with a time-zone offset. It's converted into Date/Time when loaded into the model. |
| **Duration** | :::image type="icon" source="media/data-types/duration_20.png" border="false"::: | Represents a length of time, which is converted into a Decimal Number type when loaded into the model. As a Decimal Number type, it can be added or subtracted from a Date/Time field with correct results. Because it's a Decimal Number type, you can easily use it in visualizations that show magnitude. |
| **Binary** | :::image type="icon" source="media/data-types/binary_20.png" border="false"::: | The Binary data type can be used to represent any other data with a binary format. |
| **Any** | :::image type="icon" source="media/data-types/any-type_20.png" border="false"::: | The Any data type is the status given to a column that doesn't have an explicit data type definition. Any is the data type that classifies all values. We recommend that you always explicitly define the column data types for your queries from unstructured sources. Also, avoid having any columns with the Any data type as the output of your query. |
...
:::image type="content" source="media/data-types/detect-data-type-icon-any-column.png" alt-text="Screenshot of the detect data type command on the Transform tab." lightbox="media/data-types/detect-data-type-icon-any-column.png":::

## How to define a column data type

You can define or change the data type of a column in any of four places:

- On the **Home** tab, in the **Transform** group, on the **Data type** dropdown menu.
...
- On the **Transform** tab, in the **Any column** group, on the **Data type** dropdown menu.
...
:::image type="content" source="media/data-types/project-options-auto-detect.png" alt-text="Screenshot of online option to automatically detect data types in project options." lightbox="media/data-types/project-options-auto-detect.png":::
...
- **Global**: On the left pane under **Global**, select **Data load**. On the right pane under **Type detection**, you can select any of three type detection configurations that are applied to every new file created in your application:
  ...
  :::image type="content" source="media/data-types/power-query-desktop-options-global-auto-detect.png" alt-text="Screenshot of the desktop options to set the global type detection." lightbox="media/data-types/power-query-desktop-options-global-auto-detect.png":::
...
- In Power Query Online, this interpretation is defined in the **Project** options, under **Regional settings**.
  ...
  :::image type="content" source="media/data-types/project-options-locale.png" alt-text="Screenshot of the locale option setting in Power Query Online." lightbox="media/data-types/project-options-locale.png":::
...
| Data Types | :::image type="icon" source="media/data-types/number_20.png" border="false"::: | :::image type="icon" source="media/data-types/currency_20.png" border="false"::: | :::image type="icon" source="media/data-types/whole-number_20.png" border="false"::: | :::image type="icon" source="media/data-types/percentage_20.png" border="false"::: | :::image type="icon" source="media/data-types/datetime_20.png" border="false"::: | :::image type="icon" source="media/data-types/date_20.png" border="false"::: | :::image type="icon" source="media/data-types/time_20.png" border="false"::: | :::image type="icon" source="media/data-types/datetimezone_20.png" border="false"::: | :::image type="icon" source="media/data-types/duration_20.png" border="false"::: | :::image type="icon" source="media/data-types/text_20.png" border="false"::: | :::image type="icon" source="media/data-types/logical_20.png" border="false"::: |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| :::image type="icon" source="media/data-types/number_20.png" border="false"::: Decimal number | &mdash; | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/currency_20.png" border="false"::: Currency | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/whole-number_20.png" border="false"::: Whole number | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/percentage_20.png" border="false"::: Percentage | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/datetime_20.png" border="false"::: Date/Time | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/date_20.png" border="false"::: Date | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/time_20.png" border="false"::: Time | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/datetimezone_20.png" border="false"::: Date/Time/Timezone | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/duration_20.png" border="false"::: Duration | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/text_20.png" border="false"::: Text | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | &mdash; | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: |
| :::image type="icon" source="media/data-types/logical_20.png" border="false"::: True/False | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | &mdash; |

| Icon | Description |
| --- | --- |
| :::image type="icon" source="media/data-types/checkmark-24px.png" border="false"::: | Possible |
| :::image type="icon" source="media/data-types/cancel-24px.png" border="false"::: | Not possible |
| :::image type="icon" source="media/data-types/truncate-24px.png" border="false"::: | Possible, but it adds values to the original value |
| :::image type="icon" source="media/data-types/alert-24px.png" border="false"::: | Possible, but it truncates the original value |
