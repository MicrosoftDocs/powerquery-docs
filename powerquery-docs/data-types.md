...
|**Date/Time/Timezone** | ![Date/Time/Timezone.](media/data-types/datetimezone_20.png.png) |Represents a UTC Date/Time with a time-zone offset. It's converted into Date/Time when loaded into the model.| 
