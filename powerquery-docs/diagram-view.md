...
![Example of using the + icon in a query to add a new step in the query.](images/diagram-view-plus-sign.png)
...
![Example of quick action buttons in a query as shown in the diagram view.](images/diagram-view-query-quick-actions.png)
...
You can perform more query level actions such as duplicate, reference, and so on, by selecting the query level context menu (the three vertical dots). You can also right-click in the query and get to the same context menu. 
 ...
 ![More query level actions provided by the query contextual menu by selecting the three vertical dots or by right-clicking the query.](images/diagram-view-query-more-actions.png)
...
![Emphasizing the collapse button in the context menu of the query.](images/diagram-view-expand-collapse-query.png)
...
![Highlight related queries buttons at the top of the Top US Customers query and inside the context menu.](images/diagram-view-highlight-related-queries.png)
...
![Icon and label that specify the group the query has been moved to.](images/diagram-view-queries-in-group.png) 
...
![Step level actions contextual menu displayed after selecting the ellipsis button.](images/diagram-view-step-settings-ellipsis-button.png)
...
![Properties option inside the step level contextual menu after selecting the ellipsis button.](images/diagram-view-steps-properties-ellipsis.png)
...
![Collapse button inside the query context menu after right-clicking the query.](images/diagram-view-collapse-query-from-context-menu.png)
...
![Contextual menu after right-clicking any empty space in the diagram view pane that showcases the expand all and collapse all queries options.](images/diagram-view-right-click.png)
...
![Related queries to the Top US Customers (Orders and Customers) are highlighted with a light blue background color after selecting the highlight related queries button in the Top US Customers query.](images/diagram-view-highlight-related-queries-sample.png)

You can also select the dongle on the left of a given query to see the direct and indirect referenced queries.

![Related queries to the Top US Customers (Orders and Customers) are highlighted with a light blue background color after selecting the small dongle on the left of the Top US Customers query.](images/diagram-view-highlight-related-queries-sample-dongle.png)

Similarly, you can select the right dongle to view direct and indirect dependent queries.

![Callout displays the direct dependent queries and the indirect dependent queries after selecting the right dongle of the Customers query.](images/diagram-view-highlight-related-queries-direct-indirect-dependent-queries.png)
...
![Callout displays diagram view settings after opening from the diagram view button.](images/diagram-view-settings.png)

The second way to modify diagram view settings is to right-click over a blank part of the diagram view background.

![screenshot](images/diagram-view-settings-2.png)
...
:::image type="content" source="images/show-animations.gif" alt-text="Animation showing the difference between Show animations being selected or being cleared.":::
...
![In the data preview, a red box around an up and down arrow in the top left to expand the data preview.](images/diagram-view-maximize-data-preview.jpg)
