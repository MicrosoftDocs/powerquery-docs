...
> [!IMPORTANT]
> The ***[run-compare](./pqtest-run-compare.md)*** command replaces the ***compare*** command. Please use the ***[run-compare](./pqtest-run-compare.md)*** command for any future regression testing of the Power Query connectors.
