...
<p>For example, when concatenating a VARCHAR(4000) field with a VARCHAR(4000) field on a system which supports a maximize VARCHAR size of 4000 and no CLOB type, the concatenation will be folded even though the result might get truncated.</p>
<p>Default: false</p></td>
</tr>
<tr class="even">
