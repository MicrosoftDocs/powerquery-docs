...
:::image type="complex" source="images/me-pivot-dont-aggregate-valid-initial.png" alt-text="Pivot column no aggregation":::
   Table with Country column containing USA in the first three rows, Canada in the next three rows, and Panama in the last three rows. The Position column contains 1st Place in the first, fourth, and seventh rows, 2nd Place in the second, fifth, and eighth rows, and 3rd Place in the third, sixth, and nineth rows.
:::image-end:::
...
:::image type="complex" source="images/me-pivot-columns-no-aggregation-final.png" alt-text="Pivot columns Don't aggregate result":::
   Table containing Country, 1st Place, 2nd Place, and 3rd Place columns, with the Country column containing Canada in row 1, Panama in row 2, and USA in row 3. 
:::image-end:::
