...
* **Home tab**&mdash;under the **Split Column** dropdown menu inside the **Transform** group.
   ...
   :::image type="content" source="media/splitcolumns-nondigit-to-digit/sc-home-ndtd.png" alt-text="Screenshot showing the location of By Non-Digit to Digit under the Home tab.":::

* **Transform tab**&mdash;under the **Split Column** dropdown menu inside the **Text Column** group.

   :::image type="content" source="media/splitcolumns-nondigit-to-digit/sc-transform-ndtd.png" alt-text="Screenshot showing the location of By Non-Digit to Digit under the Transform tab.":::
