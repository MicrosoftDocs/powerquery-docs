...
| Aad                 | AuthorizationUri | `text` value or function that returns the Microsoft Entra ID authorization endpoint (example: `"https://login.microsoftonline.com/common/oauth2/authorize"`).<br/></br>Go to the [Microsoft Entra ID authentication](#microsoft-entra-id-authentication) section. |
