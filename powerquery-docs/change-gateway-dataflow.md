...
1. From the **Home** tab in Power Query, select **Options**.
   ...
   :::image type="content" source="media/change-gateway/new-settings.png" alt-text="Screenshot of Options icon and selection in Power Query Home tab.":::

1. In the **Options** dialog box, select **Data load**, and then select the gateway to use for your project, in this case, Gateway B.

   :::image type="content" source="media/change-gateway/options-dialog-change-gateway.png" alt-text="Screenshot of Project options dialog box with the drop-down menu listing None, Gateway A, and Gateway B." lightbox="media/change-gateway/options-dialog-change-gateway.png":::

   > [!TIP]  
   > If there were recent changes to your gateways, select the small refresh icon to the right of the dropdown list menu to update the list of available gateways.

1. After selecting the correct gateway for the project, in this case, Gateway B, select **OK** to go back to the Power Query editor.
...
:::image type="content" source="media/change-gateway/data-source-path.png" alt-text="Screenshot of the Query setting dialog with the Source emphasized and the Folder path associated with the source." lightbox="media/change-gateway/data-source-path.png":::
...
:::image type="content" source="media/change-gateway/folder-connection-settings.png" alt-text="Screenshot of the Connect to data source dialog with the Connection settings folder path filled in." lightbox="media/change-gateway/folder-connection-settings.png":::
