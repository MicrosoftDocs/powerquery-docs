---
title: Include file for the Limitations and considerations section of the Power Query Google Analytics connector documentation
description: Include file for the Limitations and considerations section of the Power Query Google Analytics connector documentation
ms.date: 03/10/2026
ms.topic: include
---
