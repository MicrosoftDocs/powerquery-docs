---
title: Include file for the Connect to Power Query Online section of the Azure Device Registry connector documentation
description: Include file for the Connect to Power Query Online section of the Azure Device Registry connector documentation
ms.date: 03/06/2026
ms.topic: include
---
...
1. In **Choose data source**, select Azure or search for **Azure Device Registry**, and then select **Azure Device Registry**. For more information, see [Where to get data in Power Query](/power-query/where-to-get-data).
1. In **Connect to data source**, select a scope and fill in any optional or advanced fields.

   :::image type="content" source="/power-query/connectors/media/azure-device-registry/enter-information-online.png" alt-text="Screenshot of Azure Device Registry dialog in Power Query Online." lightbox="/power-query/connectors/media/azure-device-registry/enter-information-online.png":::
