...
1. Select the **Azure SQL database** option in the get data experience. Different apps have different ways of getting to the Power Query Online get data experience. For more information about how to get to the Power Query Online get data experience from your app, go to [Where to get data](/power-query/where-to-get-data).
   ...
   :::image type="content" source="/power-query/connectors/media/azure-sql-database/get-data-online.png" alt-text="Screenshot of the get data window with Azure SQL database emphasized.":::

2. In **Azure SQL database**, provide the name of the server and database.

   :::image type="content" source="/power-query/connectors/media/azure-sql-database/service-signin.png" alt-text="Screenshot of entering the Azure SQL database online connection.":::
...
7. In **Navigator**, select the data you require, and then select **Transform data**.
   ...
   :::image type="content" source="/power-query/connectors/media/azure-sql-database/navigator-online.png" alt-text="Screenshot of Power Query Online Navigator showing the Human Resources employee data.":::
