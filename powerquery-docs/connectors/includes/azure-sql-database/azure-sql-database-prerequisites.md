---
title: Include file for the Prerequisites section of the Power Query Azure SQL database connector connector documentation
description: Include file for the Prerequisites section of the Power Query Azure SQL database connector connector documentation
