---
title: Include file for the Connect to Power Query Online section of the Power Query PostgreSQL connector documentation
description: Include file for the Connect to Power Query Online section of the Power Query PostgreSQL connector documentation
