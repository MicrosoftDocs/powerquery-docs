...
* This connector isn't supported with an on-premises data gateway. However it's supported when using the [virtual network data gateway](/data-integration/vnet/use-data-gateways-sources-power-bi#supported-azure-data-services).
