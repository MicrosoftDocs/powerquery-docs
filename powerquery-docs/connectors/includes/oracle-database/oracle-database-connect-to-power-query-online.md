---
title: Include file for the Connect to Power Query Online section of the Power Query Oracle database connector documentation
description: Include file for the Connect to Power Query Online section of the Power Query Oracle database connector documentation
author: whhender
ms.author: whhender
ms.date: 03/06/2026
ms.topic: include
