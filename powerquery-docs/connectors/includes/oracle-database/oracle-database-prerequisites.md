---
title: Include file for the Prerequisites section of the Power Query Oracle database connector connector documentation
description: Include file for the Prerequisites section of the Power Query Oracle database connector connector documentation
