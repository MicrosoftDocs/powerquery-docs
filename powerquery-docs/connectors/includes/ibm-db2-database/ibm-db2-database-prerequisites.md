---
title: Include file for the Prerequisites section of the Power Query IBM Db2 database connector connector documentation
description: Include file for the Prerequisites section of the Power Query IBM Db2 database connector connector documentation
