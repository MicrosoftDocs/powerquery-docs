---
title: Include file for the Connect to Power Query Online section of the Power Query MySQL database connector documentation
description: Include file for the Connect to Power Query Online section of the Power Query MySQL database connector documentation
ms.date: 03/06/2026
ms.topic: include
---
...
2. In the **MySQL database** dialog, provide the name of the server and database.  
   ...
   :::image type="content" source="/power-query/connectors/media/mysql-database/service-signin.png" alt-text="Screenshot of the Connection settings dialog with server and database sample entries filled in.":::
