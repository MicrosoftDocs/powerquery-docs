---
title: Include file for the Connect to Power Query Online section of the Power Query Warehouse (Beta) connector documentation
description: Include file for the Connect to Power Query Online section of the Power Query Warehouse (Beta) connector documentation
ms.date: 03/06/2026
ms.topic: include
---
...
2. In **Connect to data source**, select **Sign in** to sign in to your organizational account.
   ...
   :::image type="content" source="/power-query/connectors/media/warehouse/connect-data-source.png" alt-text="Screenshot of the connect to data source screen.":::
