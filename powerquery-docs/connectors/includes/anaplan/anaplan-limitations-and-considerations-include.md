...
You might experience a credential error in the [Power Query editor](/power-query/power-query-ui) when you reopen a Power BI report or when you edit a prior data set.
...
1. Select **Recent sources**.
   ...
   :::image type="content" source="/power-query/connectors/media/anaplan/recent-sources.png" alt-text="Screenshot of the Recent resources option and the dropdown list of most recent sources.":::
...
4. Select **Remove from list**.
   ...
   :::image type="content" source="/power-query/connectors/media/anaplan/remove-from-list.png" alt-text="Screenshot of recent source menu with Remove from list emphasized.":::
