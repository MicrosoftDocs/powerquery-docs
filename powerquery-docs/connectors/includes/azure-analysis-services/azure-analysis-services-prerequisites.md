---
title: Include file for the Prerequisites section of the Power Query Azure Analysis Services database connector documentation
description: Include file for the Prerequisites section of the Power Query Azure Analysis Services database connector documentation
