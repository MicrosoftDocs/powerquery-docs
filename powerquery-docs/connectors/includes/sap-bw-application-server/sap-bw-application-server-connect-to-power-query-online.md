...
4. Set **Authentication Kind** to **Basic**. Enter your user name and password.
   ...
   :::image type="content" source="/power-query/connectors/sap-bw/get-data-online-power-apps-app.png" alt-text="Screenshot that shows the SAP BW Application Server online sign-in.":::
