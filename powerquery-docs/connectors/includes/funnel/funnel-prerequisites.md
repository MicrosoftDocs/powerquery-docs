---
title: Include file for the Prerequisites section of the Power Query Funnel connector documentation
description: Include file for the Prerequisites section of the Power Query Funnel connector documentation
ms.date: 03/06/2026
ms.topic: include
---
