---
title: Include file for the Connect to Power Query Online section of the Power Query Lakehouse (Beta) connector connector documentation
description: Include file for the Connect to Power Query Online section of the Power Query Lakehouse (Beta) connector connector documentation
