---
title: Include file for the Prerequisites section of the Power Query SQL Server Analysis Services database connector documentation
description: Include file for the Prerequisites section of the Power Query SQL Server Analysis Services database connector documentation
author: whhender
ms.author: whhender
ms.date: 03/06/2026
ms.topic: include
