---
title: Include file for the Connect to Power Query Online section of the Power Query SQL Server Analysis Services database connector documentation
description: Include file for the Connect to Power Query Online section of the Power Query SQL Server Analysis Services database connector documentation
