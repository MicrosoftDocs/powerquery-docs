---
title: Include file for the Copy your account key for Azure Table Storage section of the Power Query Azure Table Storage connector documentation
description: Include file for the Copy your account key for Azure Table Storage section of the Power Query Azure Table Storage connector documentation
...
1. Select the **Copy to clipboard** icon to copy the **Key** value.
   ...
   :::image type="content" source="/power-query/connectors/media/azure-table-storage/account-key-location.png" alt-text="Screenshot of the Access keys page, with the Key under key1 shown, and the Copy to clipboard icon emphasized.":::
