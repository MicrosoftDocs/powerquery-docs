---
title: Include file for the Prerequisites section of the TIBCO(R) Data Virtualization connector documentation
description: Include file for the Prerequisites section of the TIBCO(R) Data Virtualization connector documentation
ms.date: 03/06/2026
ms.topic: include
---
...
:::image type="content" source="/power-query/connectors/media/tibco/tdv-setup.png" alt-text="Screenshot of the TDV installation setup dialog.":::
...
:::image type="content" source="/power-query/connectors/media/tibco/tdv_dsn.png" alt-text="Screenshot of the TDV DSN Configuration dialog.":::
