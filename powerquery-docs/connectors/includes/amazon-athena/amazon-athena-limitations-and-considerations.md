---
title: Include file for the Limitations and considerations section of the Power Query Amazon Athena connector documentation
description: Include file for the Limitations and considerations section of the Power Query Amazon Athena connector documentation
author: whhender
ms.author: whhender
ms.date: 03/06/2026
ms.topic: include
