---
title: Include file for the Limitations section of the Power Query SAP HANA database connector connector documentation
description: Include file for the Limitations section of the Power Query SAP HANA database connector connector documentation
