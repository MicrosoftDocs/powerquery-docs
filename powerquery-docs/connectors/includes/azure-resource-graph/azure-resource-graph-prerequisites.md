---
title: Include file for the Prerequisites section of the Azure Resource Graph connector documentation
description: Include file for the Prerequisites section of the Azure Resource Graph connector documentation
ms.reviewer: alhudso
ms.date: 03/06/2026
ms.topic: include
---
