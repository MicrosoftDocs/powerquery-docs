...
[!INCLUDE [Includes_bitsight-security-ratings_prerequisites](includes/bitsight-security-ratings/bitsight-security-ratings-prerequisites.md)]

## Capabilities supported

[!INCLUDE [Includes_bitsight-security-ratings_capabilities-supported](includes/bitsight-security-ratings/bitsight-security-ratings-capabilities-supported.md)]
