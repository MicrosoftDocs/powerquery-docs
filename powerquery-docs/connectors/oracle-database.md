...
> [!NOTE]
> Semantic Model DirectQuery is not capable to use the built-in Oracle managed ODP.NET driver for connectivity. MashupFlight_EnableOracleBundledOdacProvider is not applicable on Semantic Model DirectQuery
