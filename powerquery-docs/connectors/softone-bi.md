...
[!INCLUDE [Includes_softone-bi_prerequisites](includes/softone-bi/softone-bi-prerequisites.md)]

## Capabilities supported

[!INCLUDE [Includes_softone-bi_capabilities-supported](includes/softone-bi/softone-bi-capabilities-supported.md)]
