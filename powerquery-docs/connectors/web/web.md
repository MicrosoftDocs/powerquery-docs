...
> [!NOTE]
>The service principal authentication only works in the web connector for SharePoint sites if the relevant SharePoint tenant has been configured as described in the [prerequisites](/fabric/data-factory/connector-sharepoint-online-list-copy-activity#prerequisites).
