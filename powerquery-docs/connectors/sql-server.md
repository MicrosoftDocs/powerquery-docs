...
3. If the SQL server isn't online, select an on-premises data gateway. Use the value `servername*` for the SQL server name when using port in the connection settings.
