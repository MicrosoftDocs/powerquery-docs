...
> [!IMPORTANT] 
> We're beginning the deprecation process for the Simba Netezza ODBC Driver for the Netezza Connector starting March, 2026. Instead, we'll be supporting the IBM Netezza ODBC Driver; customers will need to install their own IBM Netezza ODBC driver.  
...
[!INCLUDE [Includes_ibm-netezza-database_capabilities-supported](includes/ibm-netezza-database/ibm-netezza-database-capabilities-supported.md)]
...
[!INCLUDE [Includes_ibm-netezza-database_connect-to-power-query-online](includes/ibm-netezza-database/ibm-netezza-database-connect-to-power-query-online.md)]
