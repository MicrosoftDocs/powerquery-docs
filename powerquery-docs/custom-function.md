...
:::image type="content" source="media/custom-function/add-as-new-query.png" alt-text="Selecting a file to be our Sample File.":::
...
:::image type="content" source="media/custom-function/sample-file-query.png" alt-text="Sample File query.":::
...
:::image type="content" source="media/custom-function/file-parameter.png" alt-text="File parameter.":::
...
:::image type="content" source="media/custom-function/reference-file-parameter.png" alt-text="Reference the File Parameter.":::

Rename the newly created query from **File Parameter (2)** to **Transform Sample file**.

:::image type="content" source="media/custom-function/reference-file-parameter-query-renamed.png" alt-text="Renamed query Transform Sample file.":::

Right-click this new **Transform Sample file** query and select the **Create Function** option.

:::image type="content" source="media/custom-function/transform-sample-file-function.png" alt-text="Create a function from Transform Sample file.":::
...
:::image type="content" source="media/custom-function/transform-sample-file-function-window.png" alt-text="Create a function window for Transform file.":::
...
:::image type="content" source="media/custom-function/custom-function-group.png" alt-text="Function group.":::
...
:::image type="content" source="media/custom-function/custom-function-csv.png" alt-text="Interpret binary as CSV.":::
...
:::image type="content" source="media/custom-function/sample-csv-data.png" alt-text="Sample CSV data.":::
...
1. **Remove the top four rows**&mdash;This action will get rid of the rows that are considered part of the header section of the file.
   ...
   :::image type="content" source="media/custom-function/sample-csv-remove-top-rows.png" alt-text="Remove top rows from Transform Sample file.":::
...
2. **Promote headers**&mdash;The headers for your final table are now in the first row of the table. You can promote them as shown in the next image.
   ...
   :::image type="content" source="media/custom-function/sample-csv-promote-headers.png" alt-text="Use first row as headers.":::
...
:::image type="content" source="media/custom-function/final-transform-sample-query.png" alt-text="Final transform sample query.":::
...
:::image type="content" source="media/custom-function/custom-invoke-custom-function.png" alt-text="Invoke custom function button in Add column menu.":::
...
:::image type="content" source="media/custom-function/custom-invoked-custom-function.png" alt-text="Custom function invoked.":::
...
:::image type="content" source="media/custom-function/invoked-custom-function-expanded-window.png" alt-text="Expand Output Table column.":::
...
:::image type="content" source="media/custom-function/invoked-custom-function-all-data-expanded.png" alt-text="Validating that the final table contains data from all files.":::
...
:::image type="content" source="media/custom-function/second-parameter.png" alt-text="New parameter.":::
...
:::image type="content" source="media/custom-function/filter-using-second-parameter.png" alt-text="Filter Country column using the new Market parameter.":::
...
:::image type="content" source="media/custom-function/with-second-parameter.png" alt-text="Function updated with now two parameters.":::
...
:::image type="content" source="media/custom-function/errors-after-function-update.png" alt-text="Errors after function update.":::
...
:::image type="content" source="media/custom-function/updated-arguments.png" alt-text="Updating Invoked Custom Function arguments.":::
...
:::image type="content" source="media/custom-function/after-updated-arguments.png" alt-text="Final output table after updated arguments.":::
...
:::image type="content" source="media/custom-function/sample-flight-data.png" alt-text="List of codes.":::
...
:::image type="content" source="media/custom-function/sample-parameter-code.png" alt-text="Sample parameter code value.":::
...
:::image type="content" source="media/custom-function/sample-transform-query.png" alt-text="Sample transform query.":::
...
:::image type="content" source="media/custom-function/invoke-custom-function.png" alt-text="Invoking a custom function.":::
