...
<!-- 4. Optionally, enter values in any advanced options that you want to use to modify the connection query. More information: [Connect using advanced options](#connect-using-advanced-options) -->
...
**Resolution**
 ...
 We recommend configuring the Oracle Hyperion server to define the provider and standalone servers through the Essbase Administration Service (EAS) console. Refer to section _Addendum: Registering Provider and Standalone Servers in Essbase Administration Service (EAS) Console.
...
5. Select the Dimension Type field and set it to **Accounts**. Select **OK**.
   ...
   [ ![Account Dimension](./media/essbase/account_Dimension.png) ](./media/essbase/account_Dimension.png#lightbox)
