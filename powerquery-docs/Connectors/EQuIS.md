...
To connect to an **EQuIS Enterprise** site from Power BI Online, take the following steps:

1. Select the **EQuIS** connector in the connector list, then click **Connect**.
2. Type or paste the URL of the **EQuIS Enterprise** site you are connecting to, then click **OK**.
3. If this is the first time you are connecting to this site, select the authentication kind and input your credentials.
