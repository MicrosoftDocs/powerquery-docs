...
### Authenticating through Google service account

When authenticating through Google service account in Power BI Desktop, there is a specific credential format that is required by the connector.
