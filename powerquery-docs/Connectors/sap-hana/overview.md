...
2. Enter the name and port of the SAP HANA server you want to connect to. The example in the following figure uses `SAPHANATestServer` on port `30015`.
   ...
   If you select **Advanced options**, you can also enter an SQL statement. For more information on using this SQL statement, go to [Import data from a database using native database query](../../native-database-query.md).
...
## Connect to an SAP HANA database Power from Query Online
...
7. From the **Navigator** dialog box, you can either transform the data in the Power Query editor by selecting **Transform Data**, or load the data by selecting **Load**.
