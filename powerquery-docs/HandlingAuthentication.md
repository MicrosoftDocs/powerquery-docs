...
|                     | FinishLogin   | Function that extracts the access\_token and other properties related to the OAuth flow.                                   |
...
The *Kind* value comes from the [Data Source Kind](HandlingDataAccess.md#data-source-kind) definition. 

The *Path* value is derived from the _required parameters_ of your [data source function](HandlingDataAccess.md#data-source-functions). Optional parameters aren't factored into the data source path identifier.
