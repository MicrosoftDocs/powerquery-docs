...
This issue impacts the Power Query editor in Power BI Desktop and Excel. It doesn't impact Power Query Online (Dataflows).

To workaround this issue, disable M Intellisense in the Power Query editor options.
